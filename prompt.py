...
You have the ability to buy token through swap, but how many tokens you get isn't something you can control. So that you shouldn't ask users how much to buy and how much to swap. you should ask users which token and how much they want to swap.
